...
import {
  Button, Form, Col, Modal, Image, Row, Container,
  ...
  const submitReview = (e) => {
    ...
    usersRef.doc(userInfo.uid).update({
      ...
      reviews: firebase.firestore.FieldValue.arrayUnion({
        ...
        rating,
        firstName: currentUserReview.firstName,
  ...
  return (
    <>
      <Button id="ride-btn" style={{ marginLeft: 10, background: '#E84F11', border: '#E84F11' }} onClick={() => setModal(true)}>
        Find Profile
        <Image style={{ height: '25px', width: '35px' }} src={Avatar} />
      </Button>
      <Modal
        show={showModal}
        onHide={handleHide}
      ...
      >
        ...
        <Modal.Body>
          <Form.Group>
            <Form.Row>
              <Col xs={11}>
                <Form.Control id="username" placeholder="Enter username" onChange={handleChange} />
              </Col>
                    ...
                    <Container fluid>
                      <Row>
                        <Col xs={6}>
                          <Image
                            style={{
                              marginLeft: '10px', marginBottom: '10px', height: '350px', width: '350px',
                            }}
                            roundedCircle
                            fluid
                            src={profilePicture}
                        ...
                        <Col xs={6}>
                          ...
                          <h2 style={{
                            fontFamily: 'Verdana', marginTop: '20px', marginBottom: '20px', wordWrap: 'break-word', fontSize: '12pt',
                          }}
                          >
                            {userInfo.bio}
                          </h2>
                          ...
                          <Form onSubmit={submitReview} ref={formRef}>
                            <Form.Group id="email">
                              <Form.Control ref={reviewRef} placeholder="Add a review!" name="myForm" />
                            </Form.Group>
                            <Button style={{ border: '#E84F11', backgroundColor: '#E84F11' }} type="submit">Submit</Button>

                          </Form>
                          <Button
                            style={{ marginTop: '20px', border: '#E84F11', backgroundColor: '#E84F11' }}
